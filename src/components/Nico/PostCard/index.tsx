  ...
  return (
    <Grid container spacing={3} style={{marginBottom: 48}}>
      ...
      <Grid item xs={12} md={7}>
        ...
        <p style={{ margin: 0 }}>
          Praesent sed nibh sed justo semper consequat ac tempor enim. Fusce sed
          varius odio, quis faucibus nunc nulla iaculis...Praesent sed nibh sed
          justo semper consequat ac tempor enim. Fusce sed varius odio, quis
          faucibus nunc nulla iaculis...
        </p>
      </Grid>
    </Grid>
  );
